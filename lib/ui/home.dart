  ...
  @override Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ListView(children: [
        ...
        const SizedBox(height: 10),
        SizedBox(height: 40, child: ListView.builder(scrollDirection: Axis.horizontal, padding: const EdgeInsets.only(left: 15), itemCount: 5, itemBuilder: (ctx, i)=>Padding(padding: const EdgeInsets.only(right: 8), child: TVButton(onTap: (){}, child: Container(padding: const EdgeInsets.symmetric(horizontal: 20), alignment: Alignment.center, decoration: BoxDecoration(color: i==0?Colors.blueAccent:Colors.white10, borderRadius: BorderRadius.circular(20)), child: Text(["Populer", "New", "Coming", "Dubbing", "Trend"][i])))))),
